...
╔══✪〘 NSFW 〙✪══
║
╠➥ *${prefix}randombokep* (tobat bodoh)
╠➥ *${prefix}randomhentai* (tobat bodoh)
╠➥ *${prefix}randomnsfwneko* (tobat bodoh)
╠➥ *${prefix}randomtrapnime* (tobat bodoh)
╠➥ *${prefix}nhentai [kode]* (tobat bodoh)
╠➥ *${prefix}nhder [kode]* (tobat bodoh)
╠➥ *${prefix}xnxx [linkXnxx]* (tobat bodoh)
║
╚═〘 P4LUV1 BOT 〙`
}
...
exports.info = info
const snk = () => {
    return `Syarat dan Ketentuan Bot *P4LUV1*
